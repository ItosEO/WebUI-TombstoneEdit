let e=0;function t(t,i){return void 0===i&&(i={}),new Promise((a,n)=>{let s=`exec_callback_${Date.now()}_${e++}`;function r(e){delete window[e]}window[s]=(e,t,i)=>{a({errno:e,stdout:t,stderr:i}),r(s)};try{ksu.exec(t,JSON.stringify(i),s)}catch(e){n(e),r(s)}})}function i(){this.listeners={}}function a(){this.listeners={},this.stdin=new i,this.stdout=new i,this.stderr=new i}i.prototype.on=function(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)},i.prototype.emit=function(e,...t){this.listeners[e]&&this.listeners[e].forEach(e=>e(...t))},a.prototype.on=function(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)},a.prototype.emit=function(e,...t){this.listeners[e]&&this.listeners[e].forEach(e=>e(...t))};const n=new class{constructor(){this.logFile="/cache/webui_tombstone.log",this.maxLogSize=1048576,this.isInitialized=!1,this.initializeLogFile()}async initializeLogFile(){try{await t("mkdir -p /cache"),await this.rotateLogIfNeeded(),await this.writeToFile("=== WebUI Tombstone Editor Started ==="),await this.writeToFile(`\u{542F}\u{52A8}\u{65F6}\u{95F4}: ${new Date().toISOString()}`),this.isInitialized=!0}catch(e){console.error("日志系统初始化失败:",e)}}async rotateLogIfNeeded(){try{let e=await t(`[ -f "${this.logFile}" ] && wc -c < "${this.logFile}" || echo 0`);parseInt(e.stdout?.trim()||"0")>this.maxLogSize&&(await t(`tail -n 100 "${this.logFile}" > "${this.logFile}.tmp" && mv "${this.logFile}.tmp" "${this.logFile}"`),await this.writeToFile("=== 日志文件已轮转 ==="))}catch(e){}}async writeToFile(e){try{let i=new Date().toISOString(),a=`[${i}] ${e}`.replace(/'/g,"'\"'\"'");await t(`echo '${a}' >> "${this.logFile}"`)}catch(e){console.error("写入日志文件失败:",e)}}async info(e,...t){let i=this.formatMessage("INFO",e,t);this.isInitialized&&await this.writeToFile(i),console.log(i)}async warn(e,...t){let i=this.formatMessage("WARN",e,t);this.isInitialized&&await this.writeToFile(i),console.warn(i)}async error(e,...t){let i=this.formatMessage("ERROR",e,t);this.isInitialized&&await this.writeToFile(i),console.error(i)}async debug(e,...t){let i=this.formatMessage("DEBUG",e,t);this.isInitialized&&await this.writeToFile(i),console.log(i)}formatMessage(e,t,i){let a=`[${e}] ${t}`;if(i&&i.length>0){let e=i.map(e=>{if("object"==typeof e)try{return JSON.stringify(e,null,2)}catch(e){}return String(e)}).join(" ");a+=` ${e}`}return a}async operation(e,t={}){let i=`\u{64CD}\u{4F5C}: ${e}`,a=Object.keys(t).length>0?` \u{8BE6}\u{60C5}: ${JSON.stringify(t)}`:"";await this.info(i+a)}async performance(e,t){await this.info(`\u{6027}\u{80FD}: ${e} \u{8017}\u{65F6} ${t}ms`)}async getLogContent(){try{let e=await t(`cat "${this.logFile}"`);return 0===e.errno?e.stdout:""}catch(e){return await this.error("读取日志文件失败:",e),""}}async clearLog(){try{await t(`> "${this.logFile}"`),await this.writeToFile("=== 日志已清空 ==="),await this.info("日志文件已清空")}catch(e){await this.error("清空日志文件失败:",e)}}},s=(...e)=>{n.info(...e).catch(console.error)},r=(...e)=>{n.warn(...e).catch(console.error)},o=(...e)=>{n.error(...e).catch(console.error)},l=(...e)=>{n.debug(...e).catch(console.error)},u=(e,t)=>{n.operation(e,t).catch(console.error)};class c{constructor(){this.configDefinitions=this.initializeConfigDefinitions(),this.currentConfig=null}initializeConfigDefinitions(){return{enableConfig:{title:"基础开关",description:"控制墓碑机制的基础功能开关",type:"group",items:{hansEnable:{title:"启用全局墓碑机制",description:"控制整个墓碑系统的总开关",type:"boolean"},gmsEnable:{title:"GMS应用优化",description:"对Google移动服务(GMS)应用启用优化",type:"boolean"},releaseStatistic:{title:"释放统计信息",description:"收集并释放统计信息",type:"boolean"},skipToast:{title:"跳过Toast通知",description:"冻结时跳过Toast通知避免唤醒",type:"boolean"},heatGameCloseNet:{title:"高温游戏断网",description:"高温时是否关闭游戏网络",type:"boolean"},dozeRestrictSwitch:{title:"Doze模式限制",description:"在Doze模式下启用限制开关",type:"boolean"},audioByHook:{title:"音频钩子拦截",description:"通过钩子拦截音频事件减少唤醒",type:"boolean"},navigationByHook:{title:"导航钩子拦截",description:"通过钩子拦截导航事件减少唤醒",type:"boolean"},audioCheckEnable:{title:"音频状态检查",description:"启用音频状态检查",type:"boolean"},proxyWakeLockEnable:{title:"WakeLock代理",description:"启用WakeLock代理机制",type:"boolean"},cgp_v2:{title:"CGP v2",description:"使用第二代CGP功耗策略",type:"boolean"},hansWatchDogEnable:{title:"墓碑看门狗",description:"启用墓碑看门狗监控",type:"boolean"},cpnCheckByHook:{title:"组件钩子检查",description:"通过钩子检查组件状态",type:"boolean"},restoreAlarm:{title:"恢复闹钟",description:"解冻时恢复闹钟功能",type:"boolean"},uidGoneRemoveAlarm:{title:"卸载移除闹钟",description:"应用卸载时移除关联闹钟",type:"boolean"},MStateTrimMemConfig:{title:"M状态内存压缩",description:"对M状态应用启用内存压缩",type:"boolean"}}},lcdOffConfig:{title:"熄屏配置",description:"屏幕关闭时的墓碑策略",type:"group",items:{ffTotal:{title:"每次冻结数量",description:"每次冻结的最大应用数",type:"number",unit:"个"},ffInterval:{title:"冻结间隔",description:"冻结尝试间隔时间",type:"number",unit:"毫秒"},interval:{title:"检查间隔",description:"常规检查间隔时间",type:"number",unit:"毫秒"},deepSleepFreezeWhite:{title:"深度睡眠冻结白名单",description:"深度睡眠时冻结白名单应用",type:"boolean"},gameCloseNet:{title:"游戏断网",description:"熄屏时是否关闭游戏网络",type:"boolean"},idleEnable:{title:"空闲检测",description:"启用空闲状态检测",type:"boolean"}}},lcdOnConfig:{title:"亮屏配置",description:"屏幕开启时的墓碑策略",type:"group",items:{RToM:{title:"Recent→M延迟",description:"Recent状态到M状态的冻结延迟",type:"number",unit:"毫秒"},MToF:{title:"M→Frozen延迟",description:"M状态到Frozen状态的冻结延迟",type:"number",unit:"毫秒"},checkImportance:{title:"重要性检查间隔",description:"应用重要性检查间隔",type:"number",unit:"毫秒"},gameCloseNet:{title:"游戏断网",description:"亮屏时是否关闭游戏网络",type:"boolean"}}},ffConfig:{title:"快速冻结配置",description:"快速冻结机制的相关设置",type:"group",items:{enable:{title:"启用快速冻结",description:"是否启用快速冻结功能",type:"boolean"},enterTimeout:{title:"进入超时",description:"进入冻结状态的超时时间",type:"number",unit:"毫秒"},interval:{title:"冻结周期",description:"快速冻结的执行周期",type:"number",unit:"毫秒"},maxFzNum:{title:"最大冻结数",description:"单批次最大冻结应用数量",type:"number",unit:"个"}}},proxyConfig:{title:"功耗代理设置",description:"控制 alarm/service/job/broadcast 等代理开关",type:"group",items:{alarm:{title:"代理Alarm广播",description:"是否代理 AlarmManager 广播",type:"boolean"},service:{title:"代理Service广播",description:"是否代理 Service 广播",type:"boolean"},job:{title:"代理JobScheduler事件",description:"是否代理 JobScheduler 事件",type:"boolean"},broadcast:{title:"代理常规广播",description:"是否代理常规广播",type:"boolean"},proxyBCmax:{title:"最大代理广播数",description:"允许代理的最大广播数",type:"number",unit:"条"}}},superFreezeConfig:{title:"内存优化",description:"Super Freeze 相关设置",type:"group",items:{enable:{title:"启用Super Freeze",description:"是否启用 Super Freeze 机制",type:"boolean"}}},cpuCtlRus:{title:"CPU管控",description:"CPU 使用率阈值及采集配置",type:"group",items:{shortCommCpuRateCtl:{title:"短期通信CPU阈值",description:"短期通信CPU使用率阈值(%)",type:"number",unit:"%"},longCommCpuRateCtl:{title:"长期通信CPU阈值",description:"长期通信CPU使用率阈值(%)",type:"number",unit:"%"},shortSysCpuRateCtl:{title:"短期系统CPU阈值",description:"短期系统CPU使用率阈值(% * 核心数)",type:"number",unit:"%"},collectCpuInfoCycle:{title:"CPU信息收集周期",description:"CPU信息收集周期(毫秒)",type:"number",unit:"毫秒"},cpuCollectEnable:{title:"启用CPU信息收集",description:"是否启用CPU信息收集",type:"boolean"}}},restrictNet:{title:"游戏网络限制",description:"针对特定应用类型在场景中限制网络",type:"group",items:{appTypeValue:{title:"应用类型值",description:"如4代表游戏",type:"number"},delayTime:{title:"限制延迟",description:"延迟执行限制的时间",type:"number",unit:"毫秒"}}},thermalMode:{title:"高温模式",description:"设备温度触发的性能/功耗策略",type:"group",items:{enable:{title:"启用高温模式",description:"是否启用高温模式策略",type:"boolean"},enterLevel:{title:"进入温度等级",description:"达到该温度等级时进入高温模式",type:"number"},exitLevel:{title:"退出温度等级",description:"降至该温度等级时退出高温模式",type:"number"}}}}}updateValue(e,t,i){try{let a=t.split("."),n=e;for(let e=0;e<a.length-1;e++){let i=a[e];if(n.children){let e=n.children.find(e=>e.tagName===i);e||(e={tagName:i,attributes:{},children:[],textContent:""},n.children.push(e)),n=e}else throw Error(`\u{65E0}\u{6548}\u{7684}\u{914D}\u{7F6E}\u{8DEF}\u{5F84}: ${t}`)}let s=a[a.length-1];if(n.attributes)n.attributes[s]=String(i),l(`\u{914D}\u{7F6E}\u{5DF2}\u{66F4}\u{65B0}: ${t} = ${i}`);else throw Error(`\u{65E0}\u{6CD5}\u{8BBE}\u{7F6E}\u{914D}\u{7F6E}\u{503C}: ${t}`)}catch(e){throw o("更新配置值失败:",e),e}}getValue(e,t){try{let i=t.split("."),a=e;for(let e of i)if(a.children){let t=a.children.find(t=>t.tagName===e);if(t)a=t;else if(a.attributes&&void 0!==a.attributes[e])return a.attributes[e];else return}else if(a.attributes&&void 0!==a.attributes[e])return a.attributes[e];else return;return a}catch(e){o("获取配置值失败:",e);return}}getConfigDefinition(e){return this.configDefinitions[e]||null}getAllSections(){return Object.keys(this.configDefinitions)}setCurrentConfig(e){this.currentConfig=e}getCurrentConfig(){return this.currentConfig}validateValue(e,t,i){let a=this.configDefinitions[e];if(!a||!a.items||!a.items[t])return{isValid:!1,error:"未知的配置项"};switch(a.items[t].type){case"boolean":if("true"!==i&&"false"!==i)return{isValid:!1,error:"值必须是true或false"};break;case"number":if(isNaN(parseFloat(i)))return{isValid:!1,error:"值必须是数字"};break;case"string":if("string"!=typeof i)return{isValid:!1,error:"值必须是字符串"}}return{isValid:!0}}}class d{constructor(){this.configPath="/data/oplus/os/bpm/sys_elsa_config_list.xml",this.backupPath="/data/local/tmp/sys_elsa_config_list.xml.bak",this.tempDir="/data/local/tmp/tombstone_temp",this.initializeDirectories()}async initializeDirectories(){try{await t(`mkdir -p "${this.tempDir}"`),await t(`chmod 755 "${this.tempDir}"`),await s("目录初始化完成")}catch(e){await r("目录初始化警告:",e.message)}}async checkAPIAvailable(){try{let e=await t('echo "test"');return 0===e.errno}catch(e){return await o("KernelSU API检查失败:",e),!1}}async checkConfigFileExists(){try{let e=await t(`test -f "${this.configPath}"`);return 0===e.errno}catch(e){return!1}}async readConfigFile(){try{if(!await this.checkConfigFileExists())throw Error(`\u{914D}\u{7F6E}\u{6587}\u{4EF6}\u{4E0D}\u{5B58}\u{5728}: ${this.configPath}`);let e=await t(`cat "${this.configPath}"`);if(0!==e.errno)throw Error(`\u{8BFB}\u{53D6}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${e.stderr||"未知错误"}`);if(!e.stdout||0===e.stdout.trim().length)throw Error("配置文件为空");return await s("配置文件读取成功"),e.stdout}catch(e){throw await o("读取配置文件失败:",e),Error(`\u{8BFB}\u{53D6}\u{914D}\u{7F6E}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${e.message}`)}}async writeConfigFile(e){try{if(!e||0===e.trim().length)throw Error("配置内容不能为空");let i=`${this.tempDir}/config_temp_${Date.now()}.xml`,a=e.replace(/'/g,"'\"'\"'"),n=await t(`echo '${a}' > "${i}"`);if(0!==n.errno)throw Error(`\u{5199}\u{5165}\u{4E34}\u{65F6}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${n.stderr}`);let r=await t(`test -f "${i}" && test -s "${i}"`);if(0!==r.errno)throw Error("临时文件验证失败");let o=await t(`cp "${i}" "${this.configPath}"`);if(0!==o.errno)throw Error(`\u{590D}\u{5236}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${o.stderr}`);await t(`chmod 644 "${this.configPath}"`),await t(`chown system:system "${this.configPath}"`),await t(`rm -f "${i}"`),await s("配置文件写入成功")}catch(e){throw await o("写入配置文件失败:",e),Error(`\u{5199}\u{5165}\u{914D}\u{7F6E}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${e.message}`)}}async createBackup(){try{if(!await this.checkConfigFileExists())throw Error("原配置文件不存在，无法创建备份");let e=await t(`cp "${this.configPath}" "${this.backupPath}"`);if(0!==e.errno)throw Error(`\u{521B}\u{5EFA}\u{5907}\u{4EFD}\u{5931}\u{8D25}: ${e.stderr}`);return await t(`chmod 644 "${this.backupPath}"`),await s(`\u{5907}\u{4EFD}\u{521B}\u{5EFA}\u{6210}\u{529F}: ${this.backupPath}`),this.backupPath}catch(e){throw await o("创建备份失败:",e),Error(`\u{521B}\u{5EFA}\u{5907}\u{4EFD}\u{5931}\u{8D25}: ${e.message}`)}}async checkBackupExists(){try{let e=await t(`test -f "${this.backupPath}"`);return 0===e.errno}catch(e){return!1}}async getBackupInfo(){try{if(!await this.checkBackupExists())return null;let e=await t(`stat "${this.backupPath}"`);if(0!==e.errno)return null;let i=e.stdout,a=i.match(/Size:\s+(\d+)/),n=i.match(/Modify:\s+([^\n]+)/);return{path:this.backupPath,filename:"sys_elsa_config_list.xml.bak",size:a?parseInt(a[1]):0,lastModified:n?n[1].trim():"Unknown",exists:!0}}catch(e){return await o("获取备份信息失败:",e),null}}async restoreBackup(){try{if(!await this.checkBackupExists())throw Error("备份文件不存在");let e=await t(`head -1 "${this.backupPath}"`);if(0!==e.errno||!e.stdout.includes("<?xml"))throw Error("备份文件格式无效");let i=await t(`cp "${this.backupPath}" "${this.configPath}"`);if(0!==i.errno)throw Error(`\u{6062}\u{590D}\u{6587}\u{4EF6}\u{5931}\u{8D25}: ${i.stderr}`);await t(`chmod 644 "${this.configPath}"`),await t(`chown system:system "${this.configPath}"`),await s(`\u{914D}\u{7F6E}\u{6587}\u{4EF6}\u{5DF2}\u{6062}\u{590D}: ${this.backupPath}`)}catch(e){throw await o("恢复备份失败:",e),Error(`\u{6062}\u{590D}\u{5907}\u{4EFD}\u{5931}\u{8D25}: ${e.message}`)}}async deleteBackup(){try{if(!await this.checkBackupExists())return void await s("备份文件不存在，无需删除");await t(`rm -f "${this.backupPath}"`),await s("备份文件已删除")}catch(e){await r("删除备份文件时出现警告:",e.message)}}async getFileInfo(){try{if(!await this.checkConfigFileExists())return null;let e=await t(`stat "${this.configPath}"`);if(0!==e.errno)throw Error("获取文件信息失败");let i=e.stdout,a=i.match(/Size:\s+(\d+)/),n=i.match(/Modify:\s+([^\n]+)/);return{path:this.configPath,size:a?parseInt(a[1]):0,lastModified:n?n[1].trim():"Unknown",exists:!0}}catch(e){return await o("获取文件信息失败:",e),null}}async validateFileIntegrity(e=null){try{let i=e||this.configPath,a=await t(`test -f "${i}" && test -s "${i}"`);if(0!==a.errno)return!1;let n=await t(`head -1 "${i}"`);if(0!==n.errno||!n.stdout.includes("<?xml"))return!1;return!0}catch(e){return await o("文件完整性验证失败:",e),!1}}}class h{constructor(){this.currentSection="basic",this.searchTerm="",this.configData=null,this.whitelistManager=null,this.configManager=null,this.toastManager=null,this.modalManager=null,this.bindEvents()}setDependencies(e){this.whitelistManager=e.whitelistManager,this.configManager=e.configManager,this.toastManager=e.toastManager,this.modalManager=e.modalManager}initializeUI(){this.setupNavigation(),this.setupSearch(),this.hideLoading()}setupNavigation(){document.querySelectorAll(".nav-link").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();let i=e.dataset.section;this.switchSection(i)})})}setupSearch(){let e=document.getElementById("search-input");e&&e.addEventListener("input",e=>{this.searchTerm=e.target.value.toLowerCase(),this.filterConfigItems()})}switchSection(e){document.querySelectorAll(".nav-link").forEach(e=>{e.classList.remove("active")});let t=document.querySelector(`[data-section="${e}"]`);t&&t.classList.add("active"),this.currentSection=e,this.renderCurrentSection()}renderCurrentSection(){if(!this.configData)return;let e=document.getElementById("config-container");if(e){switch(this.currentSection){case"basic":this.renderBasicConfig(e);break;case"screen":this.renderScreenConfig(e);break;case"freeze":this.renderFreezeConfig(e);break;case"proxy":this.renderProxyConfig(e);break;case"memory":this.renderMemoryConfig(e);break;case"cpu":this.renderCpuConfig(e);break;case"special":this.renderSpecialConfig(e);break;case"whitelist":this.renderWhitelistConfig(e);break;case"blacklist":this.renderBlacklistConfig(e);break;default:e.innerHTML="<p>未知的配置节</p>"}e.classList.remove("hidden")}}renderBasicConfig(e){if(!this.findConfigElement("enableConfig")){e.innerHTML="<p>未找到基础配置数据</p>";return}e.innerHTML=`
            ...
            <div id="floating-add-form" class="floating-form collapsed">
                <div class="floating-form-header" id="floating-form-header">
                    <div class="floating-form-title">
                        <i class="icon-plus"></i>
                        <span>\u{6DFB}\u{52A0}${i.name}\u{9879}\u{76EE}</span>
                    </div>
        ...
        `;document.body.insertAdjacentHTML("beforeend",a),this.bindFloatingFormEvents(),setTimeout(()=>{this.toggleFloatingForm()},100),s("浮动表单已创建并显示",{listType:e,context:t})}generateFormFields(e){let t="";return e.attributes.forEach(i=>{let a=this.getAttributeDisplayName(i),n=["name","pkg","type"].includes(i);t+=`
                <div class="form-group">
...
`})),t}exportValidationResult(e){return JSON.stringify(this.createValidationSummary(e),null,2)}}class p{constructor(){this.container=null,this.toasts=new Map,this.autoCloseDelay=5e3,this.maxToasts=5,this.initializeContainer()}initializeContainer(){this.container=document.getElementById("toast-container"),this.container||r("Toast容器未找到")}show(e,t="info",i=this.autoCloseDelay){return"loading"===t?this.showLoading(e):this.showToast(t,"",e,i)}showSuccess(e,t,i=this.autoCloseDelay){this.showToast("success",e,t,i)}showError(e,t,i=2*this.autoCloseDelay){this.showToast("error",e,t,i)}showWarning(e,t,i=this.autoCloseDelay){this.showToast("warning",e,t,i)}showInfo(e,t,i=this.autoCloseDelay){this.showToast("info",e,t,i)}showToast(e,t,i,a=this.autoCloseDelay){if(!this.container)return void r("Toast容器未初始化");if(this.toasts.size>=this.maxToasts){let e=this.toasts.keys().next().value;this.removeToast(e)}let n=`toast-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,s=this.createToastElement(n,e,t,i);this.container.appendChild(s),this.toasts.set(n,{element:s,type:e,title:t,message:i,createdAt:Date.now()}),setTimeout(()=>{s.classList.add("toast-show")},10),a>0&&setTimeout(()=>{this.removeToast(n)},a);let o=s.querySelector(".toast-close");return o&&o.addEventListener("click",()=>{this.removeToast(n)}),l(`Toast\u{663E}\u{793A}: [${e.toUpperCase()}] ${t} - ${i}`),n}createToastElement(e,t,i,a){let n=document.createElement("div");n.id=e,n.className=`toast toast-${t}`;let s={success:"✅",error:"❌",warning:"⚠️",info:"ℹ️"},r=s[t]||s.info;return n.innerHTML=`
        ...
        `,this.container.appendChild(i),setTimeout(()=>{i.classList.add("toast-show")},10),this.toasts.set(t,{element:i,type:"loading",title:"",message:e,createdAt:Date.now()}),t}updateLoadingMessage(e,t){let i=this.toasts.get(e);if(i&&"loading"===i.type){let e=i.element.querySelector(".toast-message");e&&(e.textContent=t)}}showResult(e,t,i,a=null){a&&this.removeToast(a),e?this.showSuccess("操作成功",t):this.showError("操作失败",i)}}class f{constructor(){this.overlay=null,this.modal=null,this.isOpen=!1,this.currentResolve=null,this.initializeModal(),this.bindEvents()}initializeModal(){this.overlay=document.getElementById("modal-overlay"),this.modal=this.overlay?.querySelector(".modal"),l("ModalManager初始化",{hasOverlay:!!this.overlay,hasModal:!!this.modal,overlayId:this.overlay?.id,modalClass:this.modal?.className}),this.overlay&&this.modal||o("模态对话框元素未找到",{overlayExists:!!document.getElementById("modal-overlay"),modalExists:!!document.querySelector(".modal")})}bindEvents(){if(!this.overlay)return;this.overlay.addEventListener("click",e=>{e.target===this.overlay&&this.close(!1)});let e=document.getElementById("modal-close");e&&e.addEventListener("click",()=>{this.close(!1)});let t=document.getElementById("modal-cancel");t&&t.addEventListener("click",()=>{this.close(!1)});let i=document.getElementById("modal-confirm");i&&i.addEventListener("click",()=>{this.close(!0)}),document.addEventListener("keydown",e=>{"Escape"===e.key&&this.isOpen&&this.close(!1)})}showConfirm(e,t,i="确认",a="info"){return l("ModalManager.showConfirm调用",{title:e,message:t,confirmText:i,type:a,isOpen:this.isOpen}),new Promise(n=>{if(this.isOpen){r("模态对话框已经打开，拒绝新的请求"),n(!1);return}this.currentResolve=n,l("开始更新对话框内容"),this.updateContent(e,t,i,a),l("开始打开对话框"),this.open()})}showInfo(e,t,i="确定"){return this.showConfirm(e,t,i,"info")}showWarning(e,t,i="继续"){return this.showConfirm(e,t,i,"warning")}showDanger(e,t,i="删除"){return l("ModalManager.showDanger调用",{title:e,message:t,confirmText:i}),this.showConfirm(e,t,i,"danger")}showCustom(e){let{title:t="确认",message:i="",confirmText:a="确认",cancelText:n="取消",type:s="info",showCancel:r=!0,html:o=null}=e;return new Promise(e=>{if(this.isOpen)return void e(!1);this.currentResolve=e,this.updateContent(t,o||i,a,s,n,r),this.open()})}updateContent(e,t,i,a,n="取消",s=!0){if(!this.modal)return;let r=document.getElementById("modal-title");r&&(r.textContent=e);let o=document.getElementById("modal-message");o&&(t.includes("<")?o.innerHTML=t:o.textContent=t);let l=document.getElementById("modal-confirm"),u=document.getElementById("modal-cancel");if(l)switch(l.textContent=i,l.className="btn",a){case"warning":l.classList.add("btn-warning");break;case"danger":l.classList.add("btn-danger");break;default:l.classList.add("btn-primary")}u&&(u.textContent=n,u.style.display=s?"inline-flex":"none"),this.modal.className=`modal modal-${a}`}open(){return(l("ModalManager.open调用",{hasOverlay:!!this.overlay,isOpen:this.isOpen}),this.overlay)?this.isOpen?void r("模态对话框已经打开"):void(this.isOpen=!0,this.overlay.classList.remove("hidden"),s("模态对话框已打开"),document.body.style.overflow="hidden",setTimeout(()=>{let e=document.getElementById("modal-confirm");e&&e.focus()},100),console.log("模态对话框已打开")):void o("模态对话框overlay元素不存在")}close(e=!1){this.overlay&&this.isOpen&&(this.isOpen=!1,this.overlay.classList.add("hidden"),document.body.style.overflow="",this.currentResolve&&(this.currentResolve(e),this.currentResolve=null),console.log(`\u{6A21}\u{6001}\u{5BF9}\u{8BDD}\u{6846}\u{5DF2}\u{5173}\u{95ED}\u{FF0C}\u{7ED3}\u{679C}: ${e}`))}showInput(e,t,i="",a=""){return new Promise(n=>{if(this.isOpen)return void n(null);let s=`
            ...
            `;this.currentResolve=e=>{if(e){let e=document.getElementById("modal-select");a(e?e.value:null)}else a(null)},this.updateContent(e,s,"确定","info"),this.open(),setTimeout(()=>{let e=document.getElementById("modal-select");e&&e.focus()},100)})}isModalOpen(){return this.isOpen}forceClose(){this.close(!1)}escapeHtml(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}}class y{constructor(e,t,i,a){this.configManager=e,this.xmlParser=t,this.toastManager=i,this.modalManager=a,this.listTypes={whitePkg:{name:"应用白名单",description:"加入白名单的应用将获得更宽松的冻结策略",tagName:"whitePkg",attributes:["name","category"],categories:{100:"强制白名单","010":"OPPO/OnePlus白名单","001":"第三方白名单"}},ffPkg:{name:"快速冻结列表",description:"控制应用是否参与快速冻结机制",tagName:"ffPkg",attributes:["type","pkg"],types:{white:"白名单(允许快速冻结)",black:"黑名单(跳过快速冻结)",skipAppSwitch:"跳过应用切换检查"}},SysBlack:{name:"系统应用黑名单",description:"对系统应用进行限制的黑名单配置",tagName:"SysBlack",attributes:["name","version","scene","mask"]},alarm:{name:"闹钟管理列表",description:"控制应用闹钟权限的白名单/黑名单",tagName:"alarm",attributes:["type","pkg","action"],types:{white:"白名单(允许闹钟)",black:"黑名单(禁止闹钟)"}},cpnBroadcast:{name:"广播组件列表",description:"控制应用广播接收权限",tagName:"cpnBroadcast",attributes:["calling","type","pkg","action","scene"],types:{white:"白名单(允许广播)",black:"黑名单(禁止广播)"}},cpnService:{name:"服务组件列表",description:"控制应用服务调用权限",tagName:"cpnService",attributes:["calling","type","pkg","cpn","action"],types:{white:"白名单(允许服务)",black:"黑名单(禁止服务)"}},proxyBroadcast:{name:"代理广播列表",description:"控制广播代理机制的白名单/黑名单",tagName:"proxyBroadcast",attributes:["type","pkg","action"],types:{white:"白名单(不代理)",black:"黑名单(强制代理)",drop:"丢弃列表(直接丢弃)"}},proxyWL:{name:"WakeLock代理列表",description:"控制WakeLock代理机制",tagName:"wakelock",parentTag:"proxyWL",attributes:["type","tag","pkg","proxy","enable"],types:{white:"白名单(不代理)",black:"黑名单(禁止)",proxy:"代理(延迟处理)"}},proxyGps:{name:"GPS代理列表",description:"控制GPS定位代理机制",tagName:"item",parentTag:"proxyGps",attributes:["type","pkg","appType","recentUse","stillInterval"],types:{white:"白名单(不代理)",black:"黑名单(强制代理)",gray:"灰名单(条件代理)"}}}}getListItems(e){try{let t=this.listTypes[e];if(!t)throw Error(`\u{672A}\u{77E5}\u{7684}\u{5217}\u{8868}\u{7C7B}\u{578B}: ${e}`);let i=this.configManager.getCurrentConfig();if(!i)return l(`\u{914D}\u{7F6E}\u{6570}\u{636E}\u{4E3A}\u{7A7A}\u{FF0C}\u{8FD4}\u{56DE}\u{7A7A}\u{5217}\u{8868}: ${e}`),[];l(`\u{5F00}\u{59CB}\u{83B7}\u{53D6}${e}\u{5217}\u{8868}\u{FF0C}\u{914D}\u{7F6E}\u{7C7B}\u{578B}:`,{hasParentTag:!!t.parentTag,tagName:t.tagName,parentTag:t.parentTag});let a=[];return t.parentTag?this.xmlParser.findElementsByTagName(i,t.parentTag).forEach(e=>{let i=e.children?.filter(e=>e.tagName===t.tagName)||[];a.push(...i)}):a=this.xmlParser.findElementsByTagName(i,t.tagName),l(`\u{627E}\u{5230}${a.length}\u{4E2A}${e}\u{9879}\u{76EE}`),a.map(e=>(e.attributes||(r(`\u{9879}\u{76EE}\u{7F3A}\u{5C11}attributes\u{5C5E}\u{6027}:`,e),e.attributes={}),{id:this.generateItemId(e),...e.attributes,_element:e}))}catch(t){return o(`\u{83B7}\u{53D6}${e}\u{5217}\u{8868}\u{5931}\u{8D25}:`,{error:t.message||t.toString(),stack:t.stack,listType:e,configExists:!!config}),[]}}async addListItem(e,t){l(`\u{5F00}\u{59CB}\u{6DFB}\u{52A0}${e}\u{9879}\u{76EE}`,t);try{let i=this.listTypes[e];if(!i)throw Error(`\u{672A}\u{77E5}\u{7684}\u{5217}\u{8868}\u{7C7B}\u{578B}: ${e}`);l(`\u{4F7F}\u{7528}\u{914D}\u{7F6E}:`,{tagName:i.tagName,parentTag:i.parentTag,attributes:i.attributes});let a=this.configManager.getCurrentConfig();if(!a)throw Error("配置数据未加载");let n=i.attributes.filter(e=>!t.hasOwnProperty(e)||""===t[e]);if(n.length>0)throw r(`\u{7F3A}\u{5C11}\u{5FC5}\u{9700}\u{5C5E}\u{6027}:`,n),Error(`\u{7F3A}\u{5C11}\u{5FC5}\u{9700}\u{5C5E}\u{6027}: ${n.join(", ")}`);if(this.isItemExists(e,t))throw r(`\u{9879}\u{76EE}\u{5DF2}\u{5B58}\u{5728}:`,t),Error("该项目已存在");let o={tagName:i.tagName,attributes:{},children:[],textContent:""};if(i.attributes.forEach(e=>{void 0!==t[e]&&(o.attributes[e]=String(t[e]))}),l(`\u{521B}\u{5EFA}\u{7684}\u{65B0}\u{5143}\u{7D20}:`,o),i.parentTag){let e=this.xmlParser.findElementsByTagName(a,i.parentTag)[0];e||(l(`\u{521B}\u{5EFA}\u{7236}\u{5143}\u{7D20}: ${i.parentTag}`),e={tagName:i.parentTag,attributes:{},children:[],textContent:""},a.children.push(e)),e.children.push(o),l(`\u{6DFB}\u{52A0}\u{5230}\u{7236}\u{5143}\u{7D20} ${i.parentTag} \u{4E2D}`)}else a.children.push(o),l(`\u{76F4}\u{63A5}\u{6DFB}\u{52A0}\u{5230}\u{6839}\u{914D}\u{7F6E}\u{4E2D}`);return await u("添加列表项",{listType:e,item:t,elementCreated:o}),s(`${e}\u{9879}\u{76EE}\u{6DFB}\u{52A0}\u{6210}\u{529F}:`,t),!0}catch(i){throw o(`\u{6DFB}\u{52A0}${e}\u{9879}\u{76EE}\u{5931}\u{8D25}:`,{error:i.message,itemData:t,stack:i.stack}),i}}async removeListItem(e,t){l(`\u{5F00}\u{59CB}\u{5220}\u{9664}${e}\u{9879}\u{76EE}`,{itemId:t});try{let i=this.getListItems(e).find(e=>e.id===t);if(!i)throw r(`\u{8981}\u{5220}\u{9664}\u{7684}\u{9879}\u{76EE}\u{4E0D}\u{5B58}\u{5728}: ${t}`),Error("项目不存在");let a=this.configManager.getCurrentConfig(),n=this.listTypes[e];if(!a)throw Error("配置数据未加载");l(`\u{627E}\u{5230}\u{8981}\u{5220}\u{9664}\u{7684}\u{9879}\u{76EE}:`,{itemId:t,item:{...i,_element:void 0},typeConfig:{tagName:n.tagName,parentTag:n.parentTag}});let o=0;if(n.parentTag)l(`\u{4ECE}\u{5D4C}\u{5957}\u{7ED3}\u{6784}\u{4E2D}\u{5220}\u{9664}\u{FF0C}\u{7236}\u{6807}\u{7B7E}: ${n.parentTag}`),this.xmlParser.findElementsByTagName(a,n.parentTag).forEach(e=>{let i=e.children?.length||0;e.children=e.children?.filter(e=>{let i=e.tagName===n.tagName&&this.generateItemId(e)===t;return i&&o++,!i})||[];let a=e.children.length;l(`\u{7236}\u{5143}\u{7D20}\u{5B50}\u{9879}\u{6570}\u{91CF}\u{53D8}\u{5316}: ${i} -> ${a}`)});else{l(`\u{4ECE}\u{76F4}\u{63A5}\u{7ED3}\u{6784}\u{4E2D}\u{5220}\u{9664}`);let e=a.children.length;a.children=a.children.filter(e=>{let i=e.tagName===n.tagName&&this.generateItemId(e)===t;return i&&o++,!i});let i=a.children.length;l(`\u{6839}\u{914D}\u{7F6E}\u{5B50}\u{9879}\u{6570}\u{91CF}\u{53D8}\u{5316}: ${e} -> ${i}`)}if(0===o)throw r(`\u{672A}\u{627E}\u{5230}\u{8981}\u{5220}\u{9664}\u{7684}\u{5143}\u{7D20}: ${t}`),Error("未找到要删除的项目");return await u("删除列表项",{listType:e,itemId:t,item:{...i,_element:void 0},removedCount:o}),s(`${e}\u{9879}\u{76EE}\u{5220}\u{9664}\u{6210}\u{529F}:`,{itemId:t,removedCount:o}),!0}catch(i){throw o(`\u{5220}\u{9664}${e}\u{9879}\u{76EE}\u{5931}\u{8D25}:`,{error:i.message,itemId:t,listType:e,stack:i.stack}),i}}async updateListItem(e,t,i){l(`\u{5F00}\u{59CB}\u{66F4}\u{65B0}${e}\u{9879}\u{76EE}`,{itemId:t,newData:i});try{let a=this.getListItems(e).find(e=>e.id===t);if(!a)throw r(`\u{9879}\u{76EE}\u{4E0D}\u{5B58}\u{5728}: ${t}`),Error("项目不存在");let n=this.listTypes[e],o={...a};return delete o._element,l(`\u{627E}\u{5230}\u{8981}\u{66F4}\u{65B0}\u{7684}\u{9879}\u{76EE}:`,o),n.attributes.forEach(e=>{if(void 0!==i[e]){let t=a._element.attributes[e],n=String(i[e]);t!==n&&(a._element.attributes[e]=n,l(`\u{66F4}\u{65B0}\u{5C5E}\u{6027} ${e}: ${t} -> ${n}`))}}),await u("更新列表项",{listType:e,itemId:t,oldData:o,newData:i,updatedElement:a._element}),s(`${e}\u{9879}\u{76EE}\u{66F4}\u{65B0}\u{6210}\u{529F}:`,{itemId:t,newData:i}),!0}catch(a){throw o(`\u{66F4}\u{65B0}${e}\u{9879}\u{76EE}\u{5931}\u{8D25}:`,{error:a.message,itemId:t,newData:i,stack:a.stack}),a}}isItemExists(e,t){let i=this.getListItems(e);this.listTypes[e];let a=this.getKeyAttributes(e);return i.some(e=>a.every(i=>e[i]===t[i]))}getKeyAttributes(e){return({whitePkg:["name"],ffPkg:["type","pkg"],SysBlack:["name"],alarm:["type","pkg","action"],cpnBroadcast:["type","pkg","action"],cpnService:["type","pkg","cpn","action"],proxyBroadcast:["type","pkg","action"],proxyWL:["type","tag","pkg"],proxyGps:["type","pkg","appType"]})[e]||["pkg"]}generateItemId(e){return btoa(Object.entries(e.attributes||{}).map(([e,t])=>`${e}=${t}`).join("&")).replace(/[^a-zA-Z0-9]/g,"").substring(0,16)}getListTypeConfig(e){return this.listTypes[e]}getSupportedListTypes(){return Object.keys(this.listTypes).map(e=>({key:e,...this.listTypes[e]}))}}class v{constructor(){this.isInitialized=!1,this.hasUnsavedChanges=!1,this.currentConfig=null,this.configManager=null,this.fileManager=null,this.uiManager=null,this.xmlParser=null,this.validationManager=null,this.toastManager=null,this.modalManager=null,this.whitelistManager=null}async initializeModules(){try{await s("开始初始化模块..."),this.toastManager=new p,this.modalManager=new f,this.configManager=new c,this.fileManager=new d,this.uiManager=new h,this.xmlParser=new m,this.validationManager=new g,this.whitelistManager=new y(this.configManager,this.xmlParser,this.toastManager,this.modalManager),await new Promise(e=>setTimeout(e,100)),await s("模块初始化完成")}catch(e){throw await o("模块初始化失败:",e),Error(`\u{6A21}\u{5757}\u{521D}\u{59CB}\u{5316}\u{5931}\u{8D25}: ${e.message}`)}}async initialize(){try{await s("开始初始化 ColorOS 墓碑配置编辑器..."),await this.initializeModules(),await this.bindGlobalEvents(),await this.checkEnvironment(),this.uiManager.initializeUI(),this.uiManager.setDependencies({whitelistManager:this.whitelistManager,configManager:this.configManager,toastManager:this.toastManager,modalManager:this.modalManager}),await this.loadConfiguration(),this.isInitialized=!0,await s("应用初始化完成"),await u("应用启动",{version:"1.0.0",timestamp:new Date().toISOString()}),this.toastManager.show("应用初始化完成","success")}catch(e){await o("应用初始化失败:",e),this.showInitializationError("初始化失败",e.message)}}showInitializationError(e,t){try{if(this.uiManager&&"function"==typeof this.uiManager.showError)return void this.uiManager.showError(e,t)}catch(e){r("UIManager不可用，使用备用错误显示")}try{let i=document.getElementById("error-message"),a=i?.querySelector("h3"),n=document.getElementById("error-details");a&&(a.textContent=e),n&&(n.textContent=t),i&&i.classList.remove("hidden");let s=document.getElementById("loading");s&&s.classList.add("hidden")}catch(i){o("无法显示错误信息:",i),alert(`${e}: ${t}`)}}async checkEnvironment(){if(!await this.fileManager.checkAPIAvailable())throw await o("KernelSU API不可用"),Error("KernelSU API不可用，请确保在KernelSU环境中运行");await s("运行环境检查通过")}async loadConfiguration(){try{this.uiManager.showLoading();let e=await this.fileManager.readConfigFile();this.currentConfig=this.xmlParser.parse(e),this.configManager.setCurrentConfig(this.currentConfig);let t=this.xmlParser.validateStructure(this.currentConfig);t.isValid||(await r("配置文件结构验证失败:",t.errors),this.toastManager.show("配置文件结构有问题，但仍可编辑","warning")),this.uiManager.setConfigData(this.currentConfig),this.uiManager.renderCurrentSection();let i=await this.fileManager.getFileInfo();this.updateFileStatus(i),this.uiManager.hideLoading(),await s("配置文件加载完成"),await u("配置文件加载",{fileSize:i?.size||0})}catch(e){throw await o("加载配置文件失败:",e),this.uiManager.hideLoading(),e}}async saveConfiguration(){let e=null;try{if(!this.currentConfig)throw Error("没有可保存的配置数据");e=this.toastManager.show("正在保存配置...","loading"),await this.fileManager.createBackup();let t=this.xmlParser.serialize(this.currentConfig);await this.fileManager.writeConfigFile(t),this.hasUnsavedChanges=!1,this.uiManager.updateUnsavedIndicator(!1);let i=await this.fileManager.getFileInfo();this.updateFileStatus(i),e&&this.toastManager.removeToast(e),this.toastManager.show("配置保存成功","success"),await s("配置文件保存完成"),await u("配置保存",{hasChanges:this.hasUnsavedChanges})}catch(t){throw e&&this.toastManager.removeToast(e),await o("保存配置文件失败:",t),this.toastManager.show(`\u{4FDD}\u{5B58}\u{5931}\u{8D25}: ${t.message}`,"error"),t}}async backupConfiguration(){let e=null;try{e=this.toastManager.show("正在创建备份...","loading");let t=await this.fileManager.createBackup();e&&this.toastManager.removeToast(e),this.toastManager.show(`\u{5907}\u{4EFD}\u{521B}\u{5EFA}\u{6210}\u{529F}: ${t}`,"success"),await s("配置备份完成:",t),await u("创建备份",{backupPath:t})}catch(t){e&&this.toastManager.removeToast(e),await o("创建备份失败:",t),this.toastManager.show(`\u{5907}\u{4EFD}\u{5931}\u{8D25}: ${t.message}`,"error")}}async restoreConfiguration(){let e=null;try{if(!await this.modalManager.confirm("恢复备份","确定要恢复备份配置吗？当前的修改将会丢失。"))return;e=this.toastManager.show("正在恢复备份...","loading"),await this.fileManager.restoreBackup(),await this.loadConfiguration(),e&&this.toastManager.removeToast(e),this.toastManager.show("备份恢复成功","success"),await s("配置恢复完成"),await u("恢复备份")}catch(t){e&&this.toastManager.removeToast(e),await o("恢复备份失败:",t),this.toastManager.show(`\u{6062}\u{590D}\u{5931}\u{8D25}: ${t.message}`,"error")}}async handleConfigChange(e,t){try{if(!this.currentConfig)return void await r("配置数据未加载，忽略变更");let i=e.split(".");if(i.length>=2){let e=i[0],a=i[1],n=this.configManager.validateValue(e,a,t);if(!n.isValid){await r("配置验证失败:",n.error),this.toastManager.show(`\u{914D}\u{7F6E}\u{9A8C}\u{8BC1}\u{5931}\u{8D25}: ${n.error}`,"error");return}}this.xmlParser.setValueByPath(this.currentConfig,e,t),this.hasUnsavedChanges=!0,this.uiManager.updateUnsavedIndicator(!0),await s(`\u{914D}\u{7F6E}\u{5DF2}\u{66F4}\u{65B0}: ${e} = ${t}`),await u("配置变更",{path:e,value:t})}catch(e){await o("处理配置变更失败:",e),this.toastManager.show(`\u{914D}\u{7F6E}\u{66F4}\u{65B0}\u{5931}\u{8D25}: ${e.message}`,"error")}}updateFileStatus(e){let t=document.getElementById("file-status"),i=document.getElementById("last-modified");t&&e&&(t.textContent=`\u{914D}\u{7F6E}\u{6587}\u{4EF6}: \u{5DF2}\u{52A0}\u{8F7D} (${(e.size/1024).toFixed(1)} KB)`),i&&e&&(i.textContent=`\u{6700}\u{540E}\u{4FEE}\u{6539}: ${e.lastModified}`)}async bindGlobalEvents(){document.addEventListener("configChange",async e=>{let{path:t,value:i}=e.detail;await this.handleConfigChange(t,i)}),document.getElementById("save-btn")?.addEventListener("click",()=>{this.saveConfiguration()}),document.getElementById("backup-btn")?.addEventListener("click",()=>{this.backupConfiguration()}),document.getElementById("restore-btn")?.addEventListener("click",()=>{this.restoreConfiguration()}),document.getElementById("retry-btn")?.addEventListener("click",async()=>{try{let e=document.getElementById("error-message");e&&e.classList.add("hidden");let t=document.getElementById("loading");t&&t.classList.remove("hidden"),await this.initialize()}catch(e){await o("重试失败:",e),this.showInitializationError("重试失败",e.message)}}),window.addEventListener("beforeunload",e=>{this.hasUnsavedChanges&&(e.preventDefault(),e.returnValue="有未保存的更改，确定要离开吗？")}),await s("全局事件绑定完成")}}document.addEventListener("DOMContentLoaded",async()=>{try{window.tombstoneEditor=new v,await window.tombstoneEditor.initialize()}catch(a){o("应用启动失败:",a);let e=document.getElementById("error-message"),t=document.getElementById("error-details");e&&t&&(t.textContent=a.message,e.classList.remove("hidden"));let i=document.getElementById("loading");i&&i.classList.add("hidden")}});